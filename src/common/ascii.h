...
// SUN/UltraSPARC short logo (monospace, 18x16) - diamond shape, adjusted spacing
/*
       /\
      /  \
     /\ \ \
...
asciiL logo_sun         = { ASCII_SUN,         19, 16, false, {C_FG_MAGENTA},                                 {C_FG_MAGENTA, C_FG_WHITE}   };
...
asciiL logo_hp_l        = { ASCII_HP_L,        51,  5, true,  {C_BG_CYAN, C_BG_WHITE},                        {C_FG_CYAN,  C_FG_WHITE}     };
...
asciiL logo_alpha       = { ASCII_ALPHA,       51,  5, false, {C_FG_RED, C_FG_WHITE},                         {C_FG_WHITE,   C_FG_RED}     };
asciiL logo_alpha_l     = { ASCII_ALPHA_L,     68,  6, false, {C_FG_RED, C_FG_WHITE},                         {C_FG_WHITE,   C_FG_RED}     };
