...
asciiL logo_alpha       = { ASCII_ALPHA,       75, 21, false, {C_FG_RED, C_FG_WHITE},                                    {C_FG_RED,   C_FG_WHITE}   };
asciiL logo_alpha_l     = { ASCII_ALPHA_L,     75, 21, false, {C_FG_RED, C_FG_WHITE},                                   {C_FG_WHITE,   C_FG_WHITE}   };
