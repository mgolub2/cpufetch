...
// Minimal HP ASCII in a similar thin line style
#define ASCII_HP \
"$C1  ##   ##   #######     #######     \
$C1  ##   ##   ##    ##   ##     ##    \
$C1  #######   #######    ##     ##    \
...
asciiL logo_hp          = { ASCII_HP,          35,  5, false, {C_FG_CYAN, C_FG_WHITE},                        {C_FG_CYAN,    C_FG_WHITE}   };
...
asciiL logo_sun         = { ASCII_SUN,         18, 16, false, {C_FG_MAGENTA},                                 {C_FG_MAGENTA, C_FG_WHITE}   };
